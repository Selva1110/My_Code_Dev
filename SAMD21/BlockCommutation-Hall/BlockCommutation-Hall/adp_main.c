...
struct adp_msg_request_handshake ADP_INSTANCE_desc;

void ADP_INSTANCE_init(void)
{
	adp_init();
}
...
void                         ADP_INSTANCE_example(void)
{
...
void adp_app_init(void)
{
	...
	/* adp_spi_interface_init(&SPI_ADP.io, EDBG_SPI_SS_PIN); */
}
