...
struct adp_msg_request_handshake ADP_HANDLE_desc;

void ADP_HANDLE_init(void)
{
	adp_init();
}
...
void adp_app_init(void)
{
	...
	/* adp_spi_interface_init(&INTERFACE_INSTANCE.io, EDBG_SPI_SS_PIN); */
}
