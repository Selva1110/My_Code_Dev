...
#define CONF_TC0_TIMER_RC_TICK 10
#endif
// </h>
...
#define CONF_TC1_CMR_REG_VAL                                                                                           \
	(TC_CMR_TCCLKS(CONF_TC1_TCCLKS) | CONF_TC1_CLKI | TC_CMR_BURST(CONF_TC1_BURST) | TC_CMR_ETRGEDG(CONF_TC1_ETRGEDG)  \
	 | (CONF_TC1_ABETRG << TC_CMR_ABETRG_Pos) | (((~CONF_TC1_EVENT_OUTPUT_WAVE) & CONF_TC1_CPCTRG) << 14)              \
	 | ((CONF_TC1_EVENT_OUTPUT_WAVE << 15) & TC_CMR_WAVE) | (2 << 13) /* WAVSEL = 10 */                                \
	 | TC_CMR_WAVE)
#endif
